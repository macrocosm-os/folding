...
def fetch_job_details(
    max_workers: int, columns: List[str], job_id: Optional[str] = None, db_path: str = 'db/db.sqlite'
) -> Dict:
    """
...
if __name__ == "__main__":
    job_details = fetch_job_details(max_workers=2, 
                                    columns=["pdb_id"], 
                                    job_id='619c3260-bfb0-41d9-9c6d-57df9ef1a611'
                                    )
